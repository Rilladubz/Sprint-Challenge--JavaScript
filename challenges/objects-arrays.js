...
console.log(uni);
//I'm sure I'm close but time is running out.
...
// Return an array with only the animal and scientific names in it.  The individual values in the array should look like this "Name: Jackal, asiatic, Scientific: Canis aureus."
...
*/
// const lowerCase = []; <<<//didn't work using push so I could create new array? I figured it out using the 
// method below not sure if thats what is being asked for but it worked.
...
const populationTotal = zooAnimals.reduce(function (totalPop, animal) {
  return totalPop + animal.population;
}, 0)
